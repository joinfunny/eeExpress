...
exports.use = function(app) {
  if (app.EE_EXPRESS_CONFIG.app.disableInternational) {
    console.warn('app has disabled the international module.')
    return
  }
  i18n.configure(app.EE_EXPRESS_CONFIG.runtime.i18n)
  app.use(i18n.init)
}
